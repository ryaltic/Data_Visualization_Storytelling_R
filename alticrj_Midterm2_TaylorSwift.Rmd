...
### Selecting only albums choosen and unnesting tokens while creating dataframe for only the top 300 words in each album
...
metadataTaylorSwift$`Song Name` <- replace(metadataTaylorSwift$`Song Name`,metadataTaylorSwift$`Song Name`=="Snow On The Beach (feat. Lana Del Rey)","Snow On the Beach")

metadataTaylorSwift$`Song Name` <- replace(metadataTaylorSwift$`Song Name`,metadataTaylorSwift$`Song Name`=="Anti-Hero","Anti Hero")

metadataTaylorSwift$`Song Name` <- replace(metadataTaylorSwift$`Song Name`,metadataTaylorSwift$`Song Name`=="State Of Grace","State of Grace")
...
p.Valence <- ggplot(Metadata_Both) +
  ...
  annotate("rect",xmin=0,xmax=.5,ymin=0,ymax=1,fill="red",alpha=0.08)+
  annotate("text",x=.25,y=.5,label="Negative Songs", color ="red4")+
  annotate("rect",xmin=.5,xmax = 1,ymin=0,ymax=1,fill="green",alpha=0.08)+
  annotate("text",x=.75,y=.5,label="Positive Songs", color ="green4")+
  ...
  coord_cartesian(expand = F, xlim=c(-0.02,1.02))+
...
p.Tempo <- ggplot(Metadata_Both) +
  ...
  annotate("rect",xmin=0,xmax=.5,ymin=0,ymax=200,fill="red",alpha=0.08)+
  annotate("text",x=.25,y=30,label="Negative Songs", color ="red4")+
  annotate("rect",xmin=.5,xmax = 1,ymin=0,ymax=200,fill="green",alpha=0.08)+
  annotate("text",x=.75,y=30,label="Positive Songs", color ="green4")+
